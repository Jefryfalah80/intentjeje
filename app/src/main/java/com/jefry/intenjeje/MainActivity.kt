package com.isak.inttentjefryfalah
...
import com.isak.inttentjefryfalah.MoveWithDataActivity
import com.jefry.intenjeje.MoveActivity
import com.jefry.intenjeje.MoveForResultActivity
import com.jefry.intenjeje.R
...
class MainActivity : AppCompatActivity(),View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnMoveActivity = findViewById(R.id.btn_move_first_page)
        btnMoveActivity.setOnClickListener(this)

        btnMoveWithData = findViewById(R.id.btn_move_first_page)
